     ...
     # br(),
      fluidRow(id="welcome-panel",
               column(width=8, style="padding-right:55px", align="left",
                    ...
                    #   environments posed by chronic exposures to ", strong("copper"), " and ", strong("nickel"), " after considering bioavailability",
                    ...
                    #   br(), br(),
                    #   strong("Use the tool (Tier 2) when dissolved metal concentrations ", em("exceed"), 
                    #   "the default guideline values (DGVs, Tier 1)"), 
                    ...
                    #   
                    #   "BAGVs can be calculated for four levels of ", 
                    #   a("species protection",
                    #          target = "_blank", 
                    #          href="https://www.waterquality.gov.au/anz-guidelines/resources/key-concepts/level-of-protection"),
                    #   " (99%, 95%, 90% and 80%).",
                    ...
                    #           placement = "bottom"),
                    #   ", and calculate a hazard quotient (HQ)",
                    #   tooltip(bs_icon("info-circle"), 
                    #           "an indication of risk to aquatic organisms, metal concentration divided by BAGV", 
                    #           placement = "bottom"), 
                    #   br(),
                    # "Upload a comma-separated table (csv) with your water chemistry data (", 
                    # a("template", target="_blank",href="template.csv"), 
                    # " provided if needed) or test the calculator with the example dataset provided.", br(), br(), 
                    # "Brief ",strong("instructions")," are provided below along with ", strong("FAQs."), " For more instructions see ",
                    # a("the user guide with worked examples",target="_blank", href="myfile.pdf"),
                    #  br(),
